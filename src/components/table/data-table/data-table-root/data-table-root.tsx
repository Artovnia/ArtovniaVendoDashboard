...
export const DataTableRoot = <TData,>({
  ...
  const [showStickyBorder, setShowStickyBorder] =
    useState(false);
                  ...
                  >
                    {cells.map((cell, index) => {
                      ...
                      const isFirstCell =
                        firstCell !== -1
                          ? cell.column.id ===
                            visibleCells[firstCell].column
                              .id
                          : index === 0;

                      const isStickyCell =
                        isSelectCell || isFirstCell;
