...
export const LivePreview = ({ 
  blocks, 
  settings: _settings, // Reserved for future animation settings
  selectedBlockId,
  onBlockSelect 
}: LivePreviewProps) => {
      ...
      <div className="p-4 min-h-[400px] max-h-[600px] overflow-y-auto bg-[#F4F0EB]">
        {sortedBlocks.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-ui-fg-subtle font-medium mb-1">Twoja strona jest pusta</p>
            <p className="text-ui-fg-muted text-sm">Dodaj bloki, aby zobaczyć podgląd</p>
          </div>
        ) : (
