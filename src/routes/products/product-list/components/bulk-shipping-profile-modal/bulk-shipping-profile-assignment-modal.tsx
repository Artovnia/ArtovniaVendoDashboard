import { Button, Checkbox, Heading, toast } from "@medusajs/ui"
...
type BulkShippingProfileAssignmentModalProps = {
  onClose: () => void
  selectedShippingProfileId?: string
}
...
export const BulkShippingProfileAssignmentModal = ({
  onClose,
  selectedShippingProfileId,
}: BulkShippingProfileAssignmentModalProps) => {
