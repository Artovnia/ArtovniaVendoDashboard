...
export const AddCustomersForm = ({
  ...
  const form = useForm<
    zod.infer<typeof AddCustomersSchema>
  >({
    defaultValues: {
      customer_ids: [],
    },
      ...
      >
        ...
        <RouteFocusModal.Body className='size-full overflow-hidden'>
          <_DataTable
            ...
            noRecords={{
              message: t(
                'customerGroups.customers.add.list.noRecordsMessage'
              ),
            }}
          />
    ...
    () => [
      columnHelper.display({
        ...
        cell: ({ row }) => {
          ...
          const isSelected =
            row.getIsSelected() || isPreSelected;
          ...
          if (isPreSelected) {
            return (
              <Tooltip
                content={t(
                  'customerGroups.customers.alreadyAddedTooltip'
                )}
                side='right'
              >
                {Component}
