...
export const PriceListEditForm = ({
  priceList,
}: PriceListEditFormProps) => {
  ...
  const form = useForm<z.infer<typeof PriceListEditSchema>>(
    {
      defaultValues: {
        type: priceList?.type as PriceListType || PriceListType.OVERRIDE,
        title: priceList?.title || '',
        description: priceList?.description || '',
        status: priceList?.status as PriceListStatus || PriceListStatus.DRAFT,
      },
                    ...
                    <Form.Control>
                      ...
                      >
                        ...
                        <Select.Content>
                          ...
                          >
                            {t(
                              'priceLists.fields.status.options.active'
                            )}
                          </Select.Item>
                          <Select.Item
                          ...
                          >
                            {t(
                              'priceLists.fields.status.options.draft'
                            )}
                          </Select.Item>
                        </Select.Content>
                      </Select>
